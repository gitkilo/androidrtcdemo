...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelEvents {
  ...
  private void connectToRoomInternal() {
    ...
    new RoomParametersFetcher(connectionParameters.roomUrl, null, callbacks).makeRequest();
  }

//  private String getSignIn(String name)
//  {
//    return connectionParameters.roomUrl + String.format("/sign_in?%s", name);
//  }
